# Generated by Powerlevel10k configuration wizard on 2022-05-06 at 11:48 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_DISABLED_WORKDIR_PATTERN='~|*/\.terraform/*|*/\.terragrunt-cache/*'
  ...
  typeset -g POWERLEVEL9K_TERRAFORM_CLASSES=(
      ...
      '*'         OTHER)
  typeset -g POWERLEVEL9K_TERRAFORM_FOREGROUND=093
  # typeset -g POWERLEVEL9K_TERRAFORM_OTHER_VISUAL_IDENTIFIER_EXPANSION='⭐'

  typeset -g POWERLEVEL9K_TERRAFORM_ICON='ﭨ'
